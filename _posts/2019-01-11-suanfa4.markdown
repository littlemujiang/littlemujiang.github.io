...
<tr> <td>948</td>  <td>INDEX，第2栏，倒数第12行：   Reverese postorder traversal  应改为：    Reverse postorder traversal   并将该索引条目后移到倒数第2行。  这就是中文版的勘误呀，为什么退回？对应的英文版勘误本书作者 Kevin Wayne 已经确认了。 哦，对不起，这是英文版的页码。</td> <td>3</td></table>
