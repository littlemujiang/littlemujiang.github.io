...
<tr> <td>--</td>  <td>扉页 谢路云 ---> 谢路云 译</td> <td>2.0</td> </tr>
<tr> <td>--</td>  <td>译者序 倒数7 瑕不掩玉 ---> 瑕不掩瑜</td> <td>2.0</td> </tr>
<tr> <td>0.0</td>  <td>彩插第一页，表1.2.14，典型的用例： *Visual*Accumulator a = new *Visual*Accumulator(*T, 10*); 上面的 10 要改为 1.0 。</td> <td>3.0</td> </tr>
<tr> <td>1.0</td>  <td>彩插，图 4.4.6，右上角那幅图：v  --->  w 的有向边的颜色应该从黑色改为红色。</td> <td>3.0</td> </tr>
<tr> <td>1.0</td>  <td>第一页中的代码，Public应该是public</td> <td>2.0</td> </tr>
<tr> <td>1.0</td>  <td>彩插，图 4.3.6：第4幅图和第5幅图中的黑色细线（各1条）均应改为红色细线。</td> <td>3.0</td> </tr>
<tr> <td>1.0</td>  <td>图 4.4.25 的标题： Bellman-Ford 算法的轨迹  应改为：  Bellman-Ford 算法的轨迹（含负权重环的图）</td> <td>3.0</td> </tr>
<tr> <td>4.0</td>  <td>1.1.1节，“五种语法”改为“七种语法”</td> <td>3.0</td> </tr>
<tr> <td>5.0</td>  <td>灰底格式图上面的说明文字“whitelist.txt“作为参数传递给main()  上面的“whitelist.txt”应改为“largeW.txt”。  编辑说明  原书错误</td> <td>3.0</td> </tr>
<tr> <td>6.0</td>  <td>6页 5行 浮点型 ---> 双精度实数类型，原文没有出现float point字样，7页对double型的注解是双精度实数,float型的注解是单精度实数,应该统一</td> <td>2.0</td> </tr>
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>6.0</td>  <td>正文倒数第7行，算数    改为  算术</td> <td>3.0</td> </tr>
<tr> <td>7.0</td>  <td>第七页的表 1.1.2 中 double 类型的第二列运算符与第三列典型表达式不相匹配，第一个运算符是 +，而对应的表达式是减法。 3.141 - 0.03  --->  3.141 + 0.03 3.111  --->  3.171  编辑说明  原书问题，不过编辑的时候没看仔细。</td> <td>2.0</td> </tr>
<tr> <td>7.0</td>  <td>7页 倒数9 32位二进制 ---> 32个二进制位的机器字  编辑说明  字长32位的机器字</td> <td>2.0</td> </tr>
<tr> <td>9.0</td>  <td>9页 倒数11 i++;。和i--;的意思相同 ---> i++和i--的意思分别与上述的++i和--i相同  编辑说明  i++;和i--;的意思分别与上述的++i;和--i;相同</td> <td>2.0</td> </tr>
<tr> <td>15.0</td>  <td>代码下面第3行： 原文“可以使用数学模型的来估计程序的性能”，删除“的”</td> <td>3.0</td> </tr>
<tr> <td>16.0</td>  <td>16页  倒数17 java.utils.Arrays --->  java.util.Arrays</td> <td>2.0</td> </tr>
<tr> <td>16.0</td>  <td>1.1.7节上面的倒数第7行，“StdIn”应改为“In”。</td> <td>3.0</td> </tr>
<tr> <td>16.0</td>  <td>1.1.6.8，第5段2行，An Introduction to programming in Java  “Programming” 首字母大写。</td> <td>3.0</td> </tr>
<tr> <td>17.0</td>  <td>第3行，因为Math.sin()首字母M未用等宽字体。</td> <td>3.0</td> </tr>
...
<tr> <td>85.0</td>  <td>第3段代码： String item = a[--N];  应改为：  Item item = a[--N];</td> <td>3.0</td> </tr>
...
<tr> <td>197.0</td>  <td>格式中的说明文字最后两句： 所有事务输入完毕之后程序会从优先队列中按递减顺序打印出最大的M个事务。这段代码相当于将所有事务放入一个栈，遍历栈以颠倒它们的顺序并按照增序将它们打印出来。   应改为：   处理完所有交易，优先队列中存放着以增序排列的最大的M个交易。然后这段代码将它们放入到一个栈中，遍历这个栈以颠倒它们的顺序，从而将它们按降序打印出来。</td> <td>3.0</td> </tr>
...
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>257.0</td>  <td>257 页 倒数13行 （floor） --->  floor(key) 同时用代码字体</td> <td>2.0</td> </tr>
...
<tr> <td>321.0</td>  <td>格式代码： if (!st.contains(key)) st.put(key, new Queue<string>()); if (!ts.contains(val)) ts.put(val, new Queue<String>()); 这两个 if 语句均应左移六格，和上一句对齐。 StdOut.println(“ ” + s); 上述在两个 for 循环中两个输出语句中的全角双引号要改为半角双引号。</td> <td>3.0</td> </tr>
...
<tr> <td>361.0</td>  <td>练习 4.1.17：GraphProper-ties 应改为 GraphProperties 。</td> <td>3.0</td> </tr>
...
<tr> <td>388.0</td>  <td>实验题 4.2.37：  从这些顶点构成的子图中随机选取 V 个顶点   应改为：   从这幅有向图中随机选取 V 个顶点</td> <td>3.0</td> </tr>
...
<tr> <td>407.0</td>  <td>练习 4.3.9：EdgeWeighted Graph  应改为：  EdgeWeightedGraph 。  编辑说明  说明：删除一个空格。</td> <td>3.0</td> </tr>
...
<tr> <td>429.0</td>  <td>4.4.5.2 小节的标题：平行任务调度  应改为： 并行任务调度 。</td> <td>3.0</td> </tr>
<tr> <td>429.0</td>  <td>倒数第7行到倒数第6行： 给定一组需要完成的特定任务  应改为：  给定一组需要完成的任务和每个任务所需的时间 说明：其中 每个任务所需的时间 所需的时间 用楷体。</td> <td>3.0</td> </tr>
<tr> <td>431.0</td>  <td>图 4.4.17： 图中的关键路径: s ---> 0 ---> 9 ---> 6 ---> 8 ---> 2 ---> t, 必须加粗显示。</td> <td>3.0</td> </tr>
<tr> <td>433.0</td>  <td>第1行： 开始如表 4.4.7 所示。  应改为：  开始。前面添加的限制如表 4.4.7 所示。</td> <td>3.0</td> </tr>
<tr> <td>434.0</td>  <td>图 4.4.18： 为每个任务的结束顶点指出的权重为零的边  应改为：  从每个任务的结束顶点指出的权重为零的边 说明：请参阅第431页图 4.4.16 中的相同内容。</td> <td>3.0</td> </tr>
<tr> <td>435.0</td>  <td>命题 W 后第1行： 注意，要求最短路径上的任意顶点都不存在负权重环意味着最短路径是简单的  应改为：  注意，要求最短路径上的任意顶点都不存在于负权重环中意味着最短路径是简单的 说明：请参阅 命题 W 中同样的表述。</td> <td>3.0</td> </tr>
<tr> <td>435.0</td>  <td>倒数第1行： 从本节的开始，我们会不断为最短路径问题加上各种限制并找到解决相应问题的办法。  应改为：  从本节的开始到现在，我们为最短路径问题加上各种限制，使得我们能够找到解决相应问题的算法。 说明：原来的说法：我们会...，表示的是将要做的事情。实际上这是已经做过的事情。后面的句子是： 首先，我们不允许负权重边的存在；其次不接受有向环。现在我们放宽所有这些条件并重点解决一般有向图中的以下问题。</td> <td>3.0</td> </tr>
<tr> <td>437.0</td>  <td>图 4.4.22，左边从上往下数第2幅的右侧：  3        （灰色）   应改为：   3 1 ---> 3 （灰色）</td> <td>3.0</td> </tr>
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>437.0</td>  <td>倒数第3行：队列 q  应改为： 队列 queue 。</td> <td>3.0</td> </tr>
<tr> <td>437.0</td>  <td>图 4.4.22，左上角：q  应改为： queue 。</td> <td>3.0</td> </tr>
<tr> <td>437.0</td>  <td>放松边 4 → 7、4 → 5 并将顶点 7 和 4 加入队列。  应改为：  放松边 4 → 7、4 → 5 并将顶点 7 和 5 加入队列。</td> <td>3.0</td> </tr>
<tr> <td>438.0</td>  <td>第5行到第6行：4.4.2.4 节框注“边的松驰”  应改为： 4.4.2.5 节框注“顶点的松驰” 。</td> <td>3.0</td> </tr>
<tr> <td>438.0</td>  <td>命题 Y 的证明：都小于 V-1  应改为： 都不大于 V-1 。</td> <td>3.0</td> </tr>
<tr> <td>439.0</td>  <td>代码中： public double distTo(int v)       // 最短路径树实现中的标准查询算法（请见4.4.2.6节“最短路                     径API的查询方法”） public boolean hasPathTo(int v)  public Iterable<Edge> pathTo(int v)   // 4.4.6.8节框注”Bellman-Ford“的负权重检测方法  应改为：   public double distTo(int v)           // 最短路径树实现中的标准查询算法  public boolean hasPathTo(int v)          // （请见4.4.2.6框注“最短路径  public Iterable<DirectedEdge> pathTo(int v) // API的查询方法”）   编辑说明  说明：请参见第424页中的同样内容： 1. Edge 改为 DirectedEdge。 2. 注释应该针对全部的3行代码，而不是仅针对第1行代码 3. 删除：// 4.4.6.8节框注”Bellman-Ford“的负权重检测方法</td> <td>3.0</td> </tr>
<tr> <td>439.0</td>  <td>代码的倒数第2行： // 请见 6.4.6.8 节  应改为：  // 请见 4.4.6.8节框注”Bellman-Ford“算法的负权重检测方法 注意：6.4.6.8 改为 4.4.6.8</td> <td>3.0</td> </tr>
<tr> <td>439.0</td>  <td>代码中倒数第3行： public Iterable<Edge> negativeCycl()  应改为：  public Iterable<DirectedEdge> negativeCycl()</td> <td>3.0</td> </tr>
<tr> <td>439.0</td>  <td>代码的说明文字第2行： （以避免出现重复顶点）  应改为：  （队列中不出现重复的顶点） 说明：以避免出现重复顶点是 boolean 数组 onQ[] 的任务。</td> <td>3.0</td> </tr>
<tr> <td>439.0</td>  <td>倒数第9行：q  应改为： queue 。</td> <td>3.0</td> </tr>
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>439.0</td>  <td>代码第12行：!this.hasNegativeCycle() 改为：!hasNegativeCycle()</td> <td>3.0</td> </tr>
<tr> <td>440.0</td>  <td>第5行：放松无效的边  应改为： 放松失效的边 。</td> <td>3.0</td> </tr>
<tr> <td>440.0</td>  <td>表 4.4.8 后面第1行： 实现这些方法并不困难，如以下代码所示。  应改为：  实现这些方法并不困难，如第442页的代码所示。</td> <td>3.0</td> </tr>
<tr> <td>440.0</td>  <td>倒数第5行：tive-Cycle  应改为： tiveCycle 。</td> <td>3.0</td> </tr>
<tr> <td>442.0</td>  <td>右上角的代码框中的倒数第2行： public Iterable<Edge> negativeCycl()   应改为：   public Iterable<DirectedEdge> negativeCycl()</td> <td>3.0</td> </tr>
<tr> <td>442.0</td>  <td>图 4.4.25，最上方：队列  应改为： queue 。  图 4.4.24，最上方：队列  应改为： queue 。</td> <td>3.0</td> </tr>
<tr> <td>442.0</td>  <td>图 4.4.25：  第4幅图应该删除。 第3幅图需要修改如下：  边 2→7 需要从黑色改为灰色。  edgeTo[4] 的值需要从 0 改为 5，即图中的 4 0 ---> 4 0.07 改为 4 5 ---> 4 0.07 。  edgeTo[7] 的值需要从 2 改为 4，即图中的 7 2 ---> 7 0.44 改为 2 4 ---> 7 0.44 。  编辑说明  请参见：http://www.ituring.com.cn/article/35831</td> <td>3.0</td> </tr>
<tr> <td>444.0</td>  <td>图 4.4.27： 将每个权重W替换为-Ln(w)  应改为：  将每个权重w替换为-ln(w) 说明： 1. 第一个 W 从大写改为小写 。 2. Ln 改为 ln 。</td> <td>3.0</td> </tr>
<tr> <td>445.0</td>  <td>倒数第9行：用临接矩阵表示  应改为： 用邻接矩阵表示 。</td> <td>3.0</td> </tr>
<tr> <td>445.0</td>  <td>倒数第6行：提高到  应改为： 减少到 。</td> <td>3.0</td> </tr>
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>445.0</td>  <td>倒数第5行到倒数第4行： 由于 Bellman-Ford 算法计算普通应用的运行时间常常是线性的，因此在最坏情况下它的运行时间是 VE 。  应改为：  Bellman-Ford 算法计算普通应用的运行时间常常是线性的，在最坏情况下它的运行时间是 VE 。</td> <td>3.0</td> </tr>
<tr> <td>446.0</td>  <td>第9行：EdgeWe-ightedGraph  应改为： EdgeWeightedGraph 。</td> <td>3.0</td> </tr>
<tr> <td>446.0</td>  <td>练习 4.4.3：请参考练习 4.3.9  应改为： 请参考练习 4.3.10 。</td> <td>3.0</td> </tr>
<tr> <td>446.0</td>  <td>练习 4.4.4： 从 tinyEWD.txt 中（请见图 4.4.4）删去顶点 7 并给出加权有向图中以顶点 0 为起点的最短路径树，使用父链接数组表示这棵树。  应改为：  在 tinyEWD.txt 中（请见图 4.4.4）删去顶点 7 。画出加权有向图中以顶点 0 为起点的最短路径树，并使用父链接数组表示这棵树。</td> <td>3.0</td> </tr>
<tr> <td>446.0</td>  <td>练习 4.4.10： 将练习 4.4.4 中定义的有向图看作无向图，该无向图中的每条边对应有向图中的两条方向不同但权重相同的边。为对应的有向图回答练习 4.4.6 中的问题。  应改为：  将练习 4.4.4 中定义的有向图中的边看作无向边，即每条边对应加权有向图中的两条方向不同但权重相同的边。为对应的加权有向图回答练习 4.4.6 中的问题。</td> <td>3.0</td> </tr>
<tr> <td>448.0</td>  <td>第448页，提高题 4.4.27：欧拉图  应改为： 欧几里得图 。</td> <td>3.0</td> </tr>
<tr> <td>449.0</td>  <td>实验题 4.4.48：欧拉图  应改为： 欧几里得图 。</td> <td>3.0</td> </tr>
<tr> <td>452.0</td>  <td>表5.0.1  Char[] a 改为char[] a</td> <td>3.0</td> </tr>
<tr> <td>452.0</td>  <td>第452页，第18行到第19行：（为此 Java 提供了一个 StringBuilder 类，请见图 5.0.1）  应改为： （为此 Java 提供了一个 StringBuilder 类）</td> <td>3.0</td> </tr>
<tr> <td>452.0</td>  <td>第452页，倒数第6行：查找子字符串  应改为： 提取子字符串 。</td> <td>3.0</td> </tr>
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>452.0</td>  <td>正文第7行：lengt()应改为length()</td> <td>3.0</td> </tr>
<tr> <td>453.0</td>  <td>第453页，正文倒数第3行： 第463页，正文倒数第4行： 第467页，倒数第17行： Alphabet.UNICODE  应改为： Alphabet.UNICODE16 。</td> <td>3.0</td> </tr>
<tr> <td>453.0</td>  <td>第453页，表 5.0.2： 表示一个索引所需的位数  应改为：  表示一个索引所需的比特数</td> <td>3.0</td> </tr>
<tr> <td>453.0</td>  <td>页面正中： 方法 R() 和 lgR() 用来获取字母表中的字符数以及表示它们所需的位数 这里的“位数”应改为“比特数”。</td> <td>3.0</td> </tr>
<tr> <td>454.0</td>  <td>第4行：655 36  应改为： 65 536 。</td> <td>3.0</td> </tr>
<tr> <td>454.0</td>  <td>第5行到第6行： 它从命令行接受一个字符串并在标准输出上打印输入的每个字符串的出现频率  应改为：  它从命令行接受一个字符串并打印出从标准输入获得的每个字符的出现频率</td> <td>3.0</td> </tr>
<tr> <td>455.0</td>  <td>第5行到第6行： 第一类方法会从右到左检查键中的字符。这种方法一般被称为低位优先（LSD）的字符串排序。使用数字（digit）代替字符（character）的原因要追溯到相同方法在各种数学类型中的应用。 这里的“低位优先（LSD）”改为“低位优先（least-significant-digit, LSD）”。</td> <td>3.0</td> </tr>
<tr> <td>455.0</td>  <td>第9行到第10行：高位优先（马上到！）建议改为：高位优先（most-significant-digit, 马上到！）。</td> <td>3.0</td> </tr>
<tr> <td>455.0</td>  <td>5.1.1 小节第3行到第4行： 同时也是本节中将要学习的两三种字符串排序算法的基础  应改为：  同时也是本节中将要学习的三种字符串排序算法中两种的基础</td> <td>3.0</td> </tr>
<tr> <td>455.0</td>  <td>第14行： 要学习的第一种方法会将相同字符的键划入同一个切分  应改为：  要学习的第一种方法会为每个字符创建一个切分 说明：这句话的前一句是： 它们的区别之处在于高位优先的字符串排序算法在切分时仅使用键的第一个字符，而快速排序的比较则会涉及键的全部。 因此，这句话中的“字符”是指“键的第一个字符”，“相同字符的键”说不通。也可参见下句话，它说： 第二种方法则总会产生三个切分，分别对应被搜索键的第一个字符小于、等于或大于切分键的第一个字符的情况。</td> <td>3.0</td> </tr>
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>459.0</td>  <td>命题 B 的证明： 由命题 A 可知，该命题完全依赖于键索引计数法的实现是稳定的。  应改为：  该命题完全依赖于键索引计数法的实现是稳定的，这种稳定性已经在命题 A 中指出了。</td> <td>3.0</td> </tr>
<tr> <td>464.0</td>  <td>倒数第6行：（R = 655 36） 应改为： （R = 65 536）。</td> <td>3.0</td> </tr>
<tr> <td>464.0</td>  <td>图 5.1.12：字符串的结尾大于任何字符 这里的“大于”应改为“小于”。</td> <td>3.0</td> </tr>
<tr> <td>465.0</td>  <td>倒数第5行：然而  应改为： 因此 。</td> <td>3.0</td> </tr>
<tr> <td>465.0</td>  <td>代码框中： { // 对前 d 个字符排序，从a[lo]到a[hi]  应改为：  { // 从第 d 个字符开始对 a[lo] 到 a[hi] 排序</td> <td>3.0</td> </tr>
<tr> <td>466.0</td>  <td>图 5.1.14，第2栏，倒数第3行：  *s*urely  应改为： *su*rely  。   编辑说明  说明：*s* 表示 s 是黑色的，其余字符是灰色的。</td> <td>3.0</td> </tr>
<tr> <td>466.0</td>  <td>命题C这特殊格式的文字向前移两段。</td> <td>3.0</td> </tr>
<tr> <td>467.0</td>  <td>倒数第4行：然后递归适当修正方法  应改为： 然后适当修改递归调用 。</td> <td>3.0</td> </tr>
<tr> <td>467.0</td>  <td>命题 D：7wN + 3wR  应改为： ～7wN + 3wR 。</td> <td>3.0</td> </tr>
<tr> <td>468.0</td>  <td>倒数第6行：5.1.2.3 框注  应改为： 5.1.3.3 小节的框注 。 说明： 1. 并不存在 5.1.2.3 小节。 2. 这个框注是“对前 d 个字符均相同的字符串执行插入排序”，见第465页。 3. 这个框注在逻辑上是属于第464页到第465页的“5.1.3.3 小型子数组”小节的，但是在书中印刷在第465页的“5.1.3.5 额外空间”小节中。 4. 虽然这不是严重错误，但是如有可能的话，还是应该把这个框注前移到“5.1.3.3 小型子数组”小节中。 5. 注意，不要前移得太多，因为在“5.1.3.3 小型子数组”中有句话是这么说的： 我们使用了后面框注“对前 d 个字符均相同的字符串执行插入排序”中给出一个版本的插入排序。 必须前移到这句话之后，如果前移太多到了这句话之前就悲剧了。 6. 不知道编辑确认这条勘误时会不会把我的这么多废话删除掉？ :(</td> <td>3.0</td> </tr>
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>469.0</td>  <td>图 5.1.7：这个 图 5.1.7 本身 应改为： 图 5.1.17 。</td> <td>3.0</td> </tr>
<tr> <td>470.0</td>  <td>5.1.4.4 小节第1行： 且键前面的大半部分首字母均相同  应改为：  且键前面的大半部分字母均相同</td> <td>3.0</td> </tr>
<tr> <td>470.0</td>  <td>命题 E 的证明：根据命题 D  应改为： 根据命题 C 。</td> <td>3.0</td> </tr>
<tr> <td>470.0</td>  <td>倒数第5行：web.log.txt  应改为： week.log.txt 。</td> <td>3.0</td> </tr>
<tr> <td>474.0</td>  <td>第474页，倒数第7行：the sea shore  应改为： the shore 。</td> <td>3.0</td> </tr>
<tr> <td>475.0</td>  <td>第5行：操作的的实现  应改为： 操作的实现 。</td> <td>3.0</td> </tr>
<tr> <td>476.0</td>  <td>倒数第3行：字符查找树  应改为： 单词查找树 。</td> <td>3.0</td> </tr>
<tr> <td>477.0</td>  <td>第1行：关联性数组  应改为： 关联数组 。</td> <td>3.0</td> </tr>
<tr> <td>477.0</td>  <td>第477页，第3行： 在所有情况下，我们都会检查键中的每个字符并为它们在树中创建一个对应的结点。  应改为：  在所有情况下，对于键中的每个字符，我们或者进行检查，或者在树中创建一个对应的结点。</td> <td>3.0</td> </tr>
<tr> <td>478.0</td>  <td>图 5.2.4： 这幅图有3处错误。其中表示 l（两处）和 s 的箭头的起始位置应往右移一格。  编辑说明  请参见：http://www.ituring.com.cn/article/36043</td> <td>3.0</td> </tr>
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>479.0</td>  <td>倒数第3行：（请见 5.2.1.8节） 应改为： （请见 5.2.1.10节）。</td> <td>3.0</td> </tr>
<tr> <td>480.0</td>  <td>第480页，图 5.2.5：  she  by sea sells she  shell   应改为：   she  by sea sells she  shel  shell</td> <td>3.0</td> </tr>
<tr> <td>481.0</td>  <td>单词查找树中的通配符匹配 代码框：  public void collect(Node x, String pre, String pat, Queue<String> q)  应改为 private void collect(Node x, String pre, String pat, Queue<String> q)</td> <td>3.0</td> </tr>
<tr> <td>482.0</td>  <td>第4行：在进行  应改为： 再进行 。</td> <td>3.0</td> </tr>
<tr> <td>483.0</td>  <td>图 5.2.8： 非空链接  应改为：  非空链接，不能删去结点 （返回指向结点的链接）</td> <td>3.0</td> </tr>
<tr> <td>483.0</td>  <td>第1行： 框注“从单词查找树中删除一个键（和它相关联的值）”  应改为：  我们已经考虑过的代码</td> <td>3.0</td> </tr>
<tr> <td>483.0</td>  <td>命题 G：最多的键的长度  应改为： 最多为键的长度 。</td> <td>3.0</td> </tr>
<tr> <td>484.0</td>  <td>第5行：R 中的所有  应改为： 字母表中 R 个 。</td> <td>3.0</td> </tr>
<tr> <td>485.0</td>  <td>表 5.2.2，右下角：40亿  应改为： 400万 。</td> <td>3.0</td> </tr>
<tr> <td>489.0</td>  <td>第1行：keyThatMatch()  应改为： keysThatMatch() 。</td> <td>3.0</td> </tr>
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>491.0</td>  <td>第491页，提高题 5.2.14 和 5.2.15：唯一子字符串  应改为： 不同子字符串 。（共5处）</td> <td>3.0</td> </tr>
<tr> <td>492.0</td>  <td>实验题 5.2.24：war.txt  应改为： WarAndPeace.txt 。</td> <td>3.0</td> </tr>
<tr> <td>493.0</td>  <td>第3行： 子字符串请见图 5.3.1。  应改为：  子字符串，请见图 5.3.1。</td> <td>3.0</td> </tr>
<tr> <td>496.0</td>  <td>第3自然段，第2行： 当在文本 A A B A A *B* A A A A 中查找模式 A A *B* A A A 时  编辑说明  *B* 处的 B 应该加粗。</td> <td>3.0</td> </tr>
<tr> <td>496.0</td>  <td>倒数第5行：dfs  应改为： dfa 。</td> <td>3.0</td> </tr>
<tr> <td>497.0</td>  <td>正文第8行至第9行的代码“txt.charAt(i+1)(dfa[txt.charAt(i)][j])”左数第二个“(”和右数第一个“)”不是代码的一部分，这里的意思是txt.charAt(i+1)与dfa[txt.charAt(i)]等价。故应该采用中文全角字符，且不应采用等宽字体。</td> <td>3.0</td> </tr>
<tr> <td>497.0</td>  <td>第497页，右下角的代码框： int i, j, N = txt.length();  应改为：  int i, j, N = txt.length(), M = pat.length();</td> <td>3.0</td> </tr>
<tr> <td>498.0</td>  <td>第7行：txt.charAt(i)  应改为： pat.charAt(j) 。</td> <td>3.0</td> </tr>
<tr> <td>501.0</td>  <td>代码的最后： public static void main(String[] args) // 请见表 5.3.1  应改为：  public static void main(String[] args) // 请见下一页的“KMP子字符串查找算法的测试用例”代码框</td> <td>3.0</td> </tr>
<tr> <td>502.0</td>  <td>倒数第2行：“向右移动 5 个位置”应改为“向右移动 4 个位置”。</td> <td>3.0</td> </tr>
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>505.0</td>  <td>代码的最后：  public static void main(String[] args) // 请见表 5.3.1   应改为：   public static void main(String[] args) // 请见第502页的“KMP子字符串查找算法的测试用例”代码框</td> <td>3.0</td> </tr>
<tr> <td>507.0</td>  <td>第7行，公式的最后部分：t i+M  编辑说明  i+M 整个都是 t 的下标</td> <td>3.0</td> </tr>
<tr> <td>507.0</td>  <td>第11行：（请见 3.1.1.4 节） 应改为： （请见 3.4.1.4 节）。</td> <td>3.0</td> </tr>
<tr> <td>512.0</td>  <td>提高题 5.3.27：“abcd” 应改为： “abcab”。</td> <td>3.0</td> </tr>
<tr> <td>512.0</td>  <td>提高题 5.3.27：”abcabcababcababcababcab“ 应改为： “abc*abcababcababcab*abcab”。  编辑说明  说明：其中 *...* 之间的字符应加粗。</td> <td>3.0</td> </tr>
<tr> <td>512.0</td>  <td>提高题 5.3.32：唯一的子字符串  应改为： 不同的子字符串 。</td> <td>3.0</td> </tr>
<tr> <td>517.0</td>  <td>倒数第4行：“*.StdIn.*” 应改为： “.*StdIn.*”。</td> <td>3.0</td> </tr>
<tr> <td>526.0</td>  <td>class GREP 的代码，以及运行结果的最后1行（共两处）： String txt = StdIn.hasNextLine();  应改为：  String txt = StdIn.readLine();</td> <td>3.0</td> </tr>
<tr> <td>528.0</td>  <td>提高题 5.4.15，第2行：(.*1)*  应改为： (0.*1)* 。</td> <td>3.0</td> </tr>
<tr> <td>532.0</td>  <td>图 5.5.3：96位  应改为： 96 bits 。（共三处）</td> <td>3.0</td> </tr>
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>534.0</td>  <td>图 5.5.6：1 000 000位  应改为： 1000000 bits。</td> <td>3.0</td> </tr>
<tr> <td>534.0</td>  <td>倒数第4行：练习 5.4.16 和练习  应改为： 练习 5.4.16 到练习 。</td> <td>3.0</td> </tr>
<tr> <td>535.0</td>  <td>倒数第15行： 且只在最后附加32位用于记录总长度  应改为：  且附加32位用于记录总长度</td> <td>3.0</td> </tr>
<tr> <td>536.0</td>  <td>图 5.5.7： 264位  应改为： 264 bits 。（仅改程序输出的一处，第一行的标题中的不用改） 104位  应改为： 104 bits 。（两处） 50 000位  应改为： 50000 bits 。（仅改程序输出的一处，标题中的不用改） 12 536位  应改为： 12536 bits。</td> <td>3.0</td> </tr>
<tr> <td>537.0</td>  <td>图 5.5.8：1536位  应改为： 1536 bits 。</td> <td>3.0</td> </tr>
<tr> <td>537.0</td>  <td>图 5.5.8： 7 1s  应改为： 7个1，并且指向左边的箭头应再往左一点指到加粗的1的位置。 17 0s  应改为： 17个0，并且指向左边的箭头应再往左一点指到加粗的0的位置。</td> <td>3.0</td> </tr>
<tr> <td>538.0</td>  <td>倒数第2行：原来的一倍  应改为： 原来的2倍 。</td> <td>3.0</td> </tr>
<tr> <td>539.0</td>  <td>图 5.5.9 的右边：  % java PictureDump 32 36 < q32x48.rle.bin   应改为：   % java PictureDump 32 36 < q32x48.bin.rle</td> <td>3.0</td> </tr>
<tr> <td>539.0</td>  <td>图 5.5.9： 40位  应改为： 40 bits 。（两处，标题中的不用改） 32位  应改为： 32 bits 。 416位  应改为： 416 bits 。 1144位  应改为： 1144 bits 。（两处） 6144位  应改为： 6144 bits 。（两处，标题中的不用改） 2296位  应改为： 2296 bits 。（两处） 1536位  应改为： 1536 bits 。（一处，标题中的不用改）</td> <td>3.0</td> </tr>
<tr> <td>540.0</td>  <td>第17行：用了77位  应改为： 用了84位 。</td> <td>3.0</td> </tr>
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>540.0</td>  <td>第20行：加上10个  应改为： 加上11个  。</td> <td>3.0</td> </tr>
<tr> <td>541.0</td>  <td>第541页，图 5.5.10： 图中的 压缩后的比特字符串（两处）： 0 1111 1110 0 110 0 100 0 ... - ---- ----- - --- - --- - ... A    B    R A   C A   D A ... 没有对齐。应改为对齐。</td> <td>3.0</td> </tr>
<tr> <td>542.0</td>  <td>第3行：后面框注  应改为： 左边框注 。</td> <td>3.0</td> </tr>
<tr> <td>543.0</td>  <td>第17行：如左下  应改为： 如右下 。</td> <td>3.0</td> </tr>
<tr> <td>545.0</td>  <td>图 5.5.13：就是M的编码  应改为： 就是m的编码 。</td> <td>3.0</td> </tr>
<tr> <td>546.0</td>  <td>第546页，第13行：图 5.5.13 中所显示出的空间节约  应改为： 前面讨论过的空间节约 。</td> <td>3.0</td> </tr>
<tr> <td>547.0</td>  <td>5.5.6.10 小节第1行：write-Trie()  应改为： writeTrie() 。</td> <td>3.0</td> </tr>
<tr> <td>548.0</td>  <td>图 5.5.15： 120位  应改为： 120 bits 。 352位  应改为： 352 bits 。</td> <td>3.0</td> </tr>
<tr> <td>549.0</td>  <td>图 5.5.15（续）： 45056位  应改为： 45056 bits 。 23912位  应改为： 23912 bits 。 5812552位  应改为： 5812552 bits 。 3043928位  应改为： 3043928 bits 。</td> <td>3.0</td> </tr>
<tr> <td>549.0</td>  <td>图 5.5.16： 12536位  应改为： 12536 bits 。 1144 位  应改为： 1144 bits 。 816 位  应改为： 816 bits 。 2296 位  应改为： 2296 bits 。 2032 位  应改为： 2032 bits 。</td> <td>3.0</td> </tr>
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>551.0</td>  <td>第1行到第2行： 输出为12个  应改为： 输出为13个 总共96位  应改为： 总共104位 压缩比为82%  应改为： 压缩比为87%</td> <td>3.0</td> </tr>
<tr> <td>552.0</td>  <td>算法 5.11 的代码的第10行： st.put(”“ + (char) i, i);  应改为：  st.put("" + (char) i, i);  编辑说明  说明：全角的双引号改为半角的双引号。</td> <td>3.0</td> </tr>
<tr> <td>553.0</td>  <td>第5行：160位  应改为： 160 bits 。</td> <td>3.0</td> </tr>
<tr> <td>553.0</td>  <td>图 5.5.20 的标题： LZW 算法的扩展：特殊情况  应改为：  LZW 算法的展开：特殊情况</td> <td>3.0</td> </tr>
<tr> <td>553.0</td>  <td>倒数第12行：到值  应改为： 的值 。</td> <td>3.0</td> </tr>
<tr> <td>555.0</td>  <td>图 5.5.21： 12 536位  应改为： 12536 bits 18 232位  应改为： 18232 bits 2296位  应改为： 2296 bits 2824位  应改为： 2824 bits 5 812 552位  应改为： 5812552 bits （标题中的不用改） 3 043 928位  应改为： 3043928 bits 2 667 952位  应改为： 2667952 bits</td> <td>3.0</td> </tr>
<tr> <td>555.0</td>  <td>倒数第5行：还长  应改为： 变长 。</td> <td>3.0</td> </tr>
<tr> <td>556.0</td>  <td>第556页，练习 5.5.1：的编码结果  应改为： 的解码结果 。</td> <td>3.0</td> </tr>
<tr> <td>560.0</td>  <td>第560页，第14行：麦克斯维尔和玻尔兹曼  应改为： 麦克斯韦和玻尔兹曼 。</td> <td>3.0</td> </tr>
<tr> <td>561.0</td>  <td>倒数第3行：刚性碰撞  应改为： 弹性碰撞 。</td> <td>3.0</td> </tr>
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>561.0</td>  <td>倒数第2行：请见图 6.0.4  应改为： 请见图 6.0.3 。</td> <td>3.0</td> </tr>
<tr> <td>561.0</td>  <td>倒数第2行到倒数第1行： 两个粒子的碰撞也是类似的，在物理上这是不严密的，但要更加复杂一些（请见练习 6.1）。  应改为：  两个粒子的碰撞也是类似的，但要更加复杂一些（请见练习 6.1）。</td> <td>3.0</td> </tr>
<tr> <td>561.0</td>  <td>图 6.0.4 的标题：粒子和墙体  应改为： 粒子之间 。</td> <td>3.0</td> </tr>
<tr> <td>562.0</td>  <td>第3行：请见图 6.0.5  应改为： 请见图 6.0.7 。</td> <td>3.0</td> </tr>
<tr> <td>562.0</td>  <td>第8行：忽略请见图 6.0.6  应改为： 忽略 。</td> <td>3.0</td> </tr>
<tr> <td>562.0</td>  <td>第11行：操作，请见图 6.0.7  应改为： 操作 。</td> <td>3.0</td> </tr>
<tr> <td>564.0</td>  <td>第7行到第8行：它的实现如后面框注所示  应改为： 它的实现如上一页右下角的框注所示 。</td> <td>3.0</td> </tr>
<tr> <td>565.0</td>  <td>第5行： { /* 请见正文 *// }  应改为：  { /* 请见正文 */ }</td> <td>3.0</td> </tr>
<tr> <td>566.0</td>  <td>第8行到第9行： else if (a != null && b == null) a.bounceOffHorizontalWall();   else if (a == null && b != null) b.bounceOffVerticalWall();    应改为：    else if (a != null && b == null) a.bounceOffVerticalWall();   else if (a == null && b != null) b.bounceOffHorizontalWall();</td> <td>3.0</td> </tr>
<tr> <td>567.0</td>  <td>第14行：不断前进  应改为： 不断发展 。</td> <td>3.0</td> </tr>
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>567.0</td>  <td>倒数第3行：B-树中请见图 6.0.8  应改为： B-树中（请见图 6.0.8）。</td> <td>3.0</td> </tr>
<tr> <td>567.0</td>  <td>倒数第2行：键-接  应改为： 键-链接 。</td> <td>3.0</td> </tr>
<tr> <td>568.0</td>  <td>图 6.0.8： 左下角的：内部的 3-结点  应改为： 外部的 3-结点 。 右上角的：外部的 3-结点  应改为： 内部的 3-结点 。 中间的：每个红色的键  应改为： 每个加粗的键 。</td> <td>3.0</td> </tr>
<tr> <td>568.0</td>  <td>倒数第3行：6-结点结点  应改为： 6-结点 。</td> <td>3.0</td> </tr>
<tr> <td>569.0</td>  <td>图 6.0.10： 图的连线有误。  编辑说明  请参见：http://www.ituring.com.cn/article/36750</td> <td>3.0</td> </tr>
<tr> <td>569.0</td>  <td>倒数第2行： API 中的“打开”（open）和“关闭”（close）方法指的是  应改为：  API 中的术语“打开”（open）和“关闭”（close）指的是</td> <td>3.0</td> </tr>
<tr> <td>569.0</td>  <td>最后1行到第570页第1行： add() 方法是为内部页准备的，它是一个符号表操作  应改为：  内部页的 add() 方法是一个符号表操作 第570页，第1行到第2行： add() 和 contains() 方法是为外部页准备的，和 SET 中相应的方法类似。  应改为：  外部页的 add() 和 contains() 方法和 SET 中相应的方法类似。</td> <td>3.0</td> </tr>
<tr> <td>570.0</td>  <td>第7行：用网页实现 Page  应改为： 实现 Page 用于网页。</td> <td>3.0</td> </tr>
<tr> <td>571.0</td>  <td>第6行：一倍  应改为： 两倍 。</td> <td>3.0</td> </tr>
<tr> <td>571.0</td>  <td>算法 6.12  应改为： 算法 6.1 。</td> <td>3.0</td> </tr>
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>571.0</td>  <td>算法6.12 B-树集合的实现： 这个算法的代码中的所有 put 都应改为 add，共七处： put(sentinel); put(root, key); root.put(lefthalf); root.put(righthalf); if (h.isExternal()) { h.put(key); return; } put(next, key); h.put(next.split());  应改为：  add(sentinel); add(root, key); root.add(lefthalf); root.add(righthalf); if (h.isExternal()) { h.add(key); return; } add(next, key); h.add(next.split());</td> <td>3.0</td> </tr>
<tr> <td>573.0</td>  <td>倒数第12行到倒数第11行： 将一个字符串中起始位置为 i 的子字符串与另一个字符串中起始位置为 j 的子字符串相比较  应改为：  将字符串中每个起始位置为 i 的子字符串与另一个起始位置为 j 的子字符串相比较</td> <td>3.0</td> </tr>
<tr> <td>575.0</td>  <td>倒数第3行：方法、select() 倒数第2行：索引值、lcp() 倒数第1行：前缀、rank() 这里的三个顿号（、）应改为逗号（，）。</td> <td>3.0</td> </tr>
<tr> <td>576.0</td>  <td>第11行：在右边框注所示的例子中  应改为： 在图 6.0.15 所示的例子中 。</td> <td>3.0</td> </tr>
<tr> <td>577.0</td>  <td>倒数第3行：算法 3.2（续） 应改为： 算法 3.2（续1）。</td> <td>3.0</td> </tr>
<tr> <td>577.0</td>  <td>倒数第10行：算法 6.13  应改为： 算法 6.2 。</td> <td>3.0</td> </tr>
<tr> <td>578.0</td>  <td>算法 6.13  应改为： 算法 6.2 。</td> <td>3.0</td> </tr>
<tr> <td>578.0</td>  <td>算法 6.13： // 请见 6.0.3.2 节框注“两个字符串的最长公共前缀” 这行之前需要增加以下一行： private static int lcp(String s, string t)</td> <td>3.0</td> </tr>
<tr> <td>582.0</td>  <td>第4行：命题 C  应改为： 命题 E 。</td> <td>3.0</td> </tr>
<tr> <td>582.0</td>  <td>倒数第7行：WeightedEdge  应改为： Edge 。</td> <td>3.0</td> </tr>
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>582.0</td>  <td>倒数第6行：WeightedDirectedEdge  应改为： DirectedEdge 。</td> <td>3.0</td> </tr>
<tr> <td>582.0</td>  <td>倒数第1行：WeightedEdge  应改为： EdgeWeightedGraph 。</td> <td>3.0</td> </tr>
<tr> <td>582.0</td>  <td>倒数第6行：但 FlowEdge 的基类并不是  应改为： 但 FlowEdge 并不是基于 。</td> <td>3.0</td> </tr>
<tr> <td>582.0</td>  <td>检查流量网络中的一种流量配置是否可行 代码框，倒数第8行：e.cap()  应改为： e.capacity() 。</td> <td>3.0</td> </tr>
<tr> <td>582.0</td>  <td>第582页，代码框中的第二行： {   // 检查每个顶点v的局部平衡  应改为：  {   // 检查顶点v的局部平衡</td> <td>3.0</td> </tr>
<tr> <td>583.0</td>  <td>第2行：框注  应改为： 上一页框注 。</td> <td>3.0</td> </tr>
<tr> <td>583.0</td>  <td>表 6.0.4，倒数第2行：addFlowTo  应改为： addResidualFlowTo 。</td> <td>3.0</td> </tr>
<tr> <td>584.0</td>  <td>图 6.0.21 的第3幅0-2线应为全灰。  编辑说明  请参见：http://www.ituring.com.cn/article/36800</td> <td>3.0</td> </tr>
<tr> <td>585.0</td>  <td>第15行到第16行： 切分会从入口流向出口的原油完全切断  应改为：  一个切分提供了将从入口流向出口的原油完全切断的方法</td> <td>3.0</td> </tr>
<tr> <td>588.0</td>  <td>正文第一行 residualCapacityTo() 和 residualFlowTo() 方法实现了剩余网络。  应改为：  residualCapacityTo() 和 addResidualFlowTo() 方法实现了剩余网络。</td> <td>3.0</td> </tr>
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>589.0</td>  <td>第589页，第1行和第4行：算法 6.14  应改为： 算法 6.3 。（共两处）</td> <td>3.0</td> </tr>
<tr> <td>594.0</td>  <td>第6行：优先级调度示例问题  应改为： 优先级限制下的并行任务调度问题 。</td> <td>3.0</td> </tr>
<tr> <td>595.0</td>  <td>图 6.0.25：该图中的第2幅图忘了把最大流量配置的边涂成灰色。  编辑说明  参见本书英文版第906页。</td> <td>3.0</td> </tr>
<tr> <td>595.0</td>  <td>倒数第15行：4-7 和 6-11  应改为： 4-7、5-10 和 6-11 。</td> <td>3.0</td> </tr>
<tr> <td>595.0</td>  <td>图 6.0.25：这幅图中的第1幅图和第2幅图的终点（在最下方）的名称都应改为 t，而不是 s 。</td> <td>3.0</td> </tr>
<tr> <td>596.0</td>  <td>命题 K 的 例证，第1行：练习 6.49  应改为： 练习 6.50 。</td> <td>3.0</td> </tr>
<tr> <td>596.0</td>  <td>图 6.0.26：该图中的最后一幅图忘了把最大流量配置的边涂成灰色。  编辑说明  英文版第907页</td> <td>3.0</td> </tr>
<tr> <td>598.0</td>  <td>倒数第2行：前面框注  应改为： 后面框注 。</td> <td>3.0</td> </tr>
<tr> <td>598.0</td>  <td>倒数第1行：有向图  应改为： 图 。</td> <td>3.0</td> </tr>
<tr> <td>599.0</td>  <td>倒数第4行：在 6.0.6.5 节  应改为： 在 6.0.6.6 节 。</td> <td>3.0</td> </tr>
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>601.0</td>  <td>表 6.0.7，最后1行：请见表 6.0.7  应改为： 请见表 6.0.8 。</td> <td>3.0</td> </tr>
<tr> <td>604.0</td>  <td>第20行：找出它的最大因数  应改为： 找出它的一个非平凡因数 。</td> <td>3.0</td> </tr>
<tr> <td>605.0</td>  <td>倒数第1行：1.3806503  应改为： 1.3806488 。</td> <td>3.0</td> </tr>
<tr> <td>608.0</td>  <td>练习 6.31：Burrow-Wheeler  应改为： Burrows-Wheeler 。（共4处）</td> <td>3.0</td> </tr>
<tr> <td>608.0</td>  <td>练习 6.31，倒数第2行：逆变换是  应改为： 逆变换（BWI）是 。</td> <td>3.0</td> </tr>
<tr> <td>609.0</td>  <td>练习 6.42：用练习 6.42 中  应改为： 用练习 6.41 中 。</td> <td>3.0</td> </tr>
<tr> <td>609.0</td>  <td>练习 6.49：最大因数  应改为： 一个非平凡因数 。</td> <td>3.0</td> </tr>
<tr> <td>611.0</td>  <td>索引，右栏，第15行：Aliasing  应改为： Aliasing（别名）。</td> <td>3.0</td> </tr>
<tr> <td>611.0</td>  <td>索引，右栏，第16行：of arrays（别名）  应改为： of arrays（数组）。</td> <td>3.0</td> </tr>
<tr> <td>611.0</td>  <td>索引，右栏，第18行：of substrings（子数组）  应改为： of substrings（子字符串）。</td> <td>3.0</td> </tr>
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>614.0</td>  <td>索引，左栏，C 字头前面1项：原书数据类型  应改为： 原始数据类型 。</td> <td>3.0</td> </tr>
<tr> <td>614.0</td>  <td>索引，右栏，第3行：认证  应改为： 证明 。</td> <td>3.0</td> </tr>
<tr> <td>615.0</td>  <td>索引，右栏，第25行：见最短路径算法  应改为： 见关键路径算法 。</td> <td>3.0</td> </tr>
<tr> <td>615.0</td>  <td>索引，右栏，第30行：关键路径法  应改为： 关键路径算法 。</td> <td>3.0</td> </tr>
<tr> <td>617.0</td>  <td>索引，左栏，倒数第14行：拓补排序  应改为： 拓扑排序 。</td> <td>3.0</td> </tr>
<tr> <td>617.0</td>  <td>索引，右栏，第14行到第18行：这5行应该整体左移2格，向本栏第1行看齐。</td> <td>3.0</td> </tr>
<tr> <td>617.0</td>  <td>索引，右栏，倒数第10行：加权有向图  应改为： 无环加权有向图 。</td> <td>3.0</td> </tr>
<tr> <td>618.0</td>  <td>索引，左栏，第27行：欧几里德算法  应改为： 欧几里得算法 。</td> <td>3.0</td> </tr>
<tr> <td>618.0</td>  <td>索引，右栏，倒数第22行：向上取整函数  应改为： 向下取整函数 。</td> <td>3.0</td> </tr>
<tr> <td>622.0</td>  <td>索引，右栏，第19行：ConcurrentModification  应改为： ConcurrentModificationException 。</td> <td>3.0</td> </tr>
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>622.0</td>  <td>索引，K 字头前面1项：JIT 编辑器  应改为： JIT 编译器 。</td> <td>3.0</td> </tr>
<tr> <td>625.0</td>  <td>索引，左栏，倒数第1行：该行必须右移2格。</td> <td>3.0</td> </tr>
<tr> <td>625.0</td>  <td>索引，右栏，倒数第11行：向上取整和向下取整函数  应改为： 向下取整和向上取整函数 。</td> <td>3.0</td> </tr>
<tr> <td>626.0</td>  <td>索引，左栏，第9行：过载  应改为： 重载 。</td> <td>3.0</td> </tr>
<tr> <td>626.0</td>  <td>索引，右栏，第18行：Kendall's tau 距离  应改为： Kendall tau 距离 。</td> <td>3.0</td> </tr>
<tr> <td>627.0</td>  <td>索引，左栏，第5行：对于无向图  应改为： 对于有向图 。</td> <td>3.0</td> </tr>
<tr> <td>627.0</td>  <td>索引，左栏，倒数第16行：演算法  应改为： 概率算法 。</td> <td>3.0</td> </tr>
<tr> <td>629.0</td>  <td>第629页，索引，左栏，第8行：最大流消减  应改为： 最大流归约 。</td> <td>3.0</td> </tr>
<tr> <td>629.0</td>  <td>索引，左栏，倒数第14行：拓补排序  应改为： 拓扑排序 。</td> <td>3.0</td> </tr>
<tr> <td>629.0</td>  <td>索引，右栏，倒数第18行：拉斯维佳斯  应改为： 拉斯维加斯。</td> <td>3.0</td> </tr>
<tr> <td></td>  <td></td> <td></td> </tr>
<tr> <td>630.0</td>  <td>索引，左栏，倒数第16行：线性归划  应改为： 线性规划 。</td> <td>3.0</td> </tr>
<tr> <td>630.0</td>  <td>索引，右栏，第13行：完整的比较序列  应改为： 全序关系 。</td> <td>3.0</td> </tr>
<tr> <td>630.0</td>  <td>索引，右栏，倒数第2行：立方级别  应改为： 平方级别 。</td> <td>3.0</td> </tr>
<tr> <td>630.0</td>  <td>索引，右栏，第22行：  Reverese postorder traversal  应改为：   Reverse postorder traversal  并将该索引条目后移到第31行。</td> <td>3.0</td> </tr>
<tr> <td>632.0</td>  <td>索引，右栏，第3行：rul  应改为： rule 。</td> <td>3.0</td> </tr>
<tr> <td>633.0</td>  <td>索引，右栏，倒数第19行：向上取整和向下取整  应改为： 向下取整和向上取整 。</td> <td>3.0</td> </tr>
<tr> <td>634.0</td>  <td>索引，左栏，倒数第17行：拓补排序  应改为： 拓扑排序 。</td> <td>3.0</td> </tr>
<tr> <td>634.0</td>  <td>索引，左栏，倒数第13行：完整比较序列  应改为： 全序关系 。</td> <td>3.0</td> </tr>
<tr> <td>948.0</td>  <td>INDEX，第2栏，倒数第12行：   Reverese postorder traversal  应改为：    Reverse postorder traversal   并将该索引条目后移到倒数第2行。  这就是中文版的勘误呀，为什么退回？对应的英文版勘误本书作者 Kevin Wayne 已经确认了。 哦，对不起，这是英文版的页码。</td> <td>3.0</td> </tr>
<tr> <td> </td>  <td></td> <td></td> </tr>
</table>
